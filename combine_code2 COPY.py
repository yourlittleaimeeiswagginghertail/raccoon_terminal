...
for repeat in range(a):
    ...
    print(abstracts_AND_titles_words)
    #вот здесь очистить слова в list_одного_файла от запятых, и тд
    for masu_1_porakep in abstracts_AND_titles_words:
        
        print(masu_1_porakep)
